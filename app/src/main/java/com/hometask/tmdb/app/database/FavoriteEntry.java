package com.hometask.tmdb.app.database;
...
/**
 * Данный класс, помеченный как @Entity (сущность) определяет данные хранимые в бд.
 * Это же класс будет использоваться при создании таблицы. В качестве имени таблицы
 * будет выступать имя класса, а поля таблицы - поля класса
 */
